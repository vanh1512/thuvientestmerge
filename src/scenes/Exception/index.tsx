...
class Exception extends React.Component<any, any> {
	public render() {
		const exception = [
			{ errorCode: '404', errorImg: error404, errorDescription: L('Sorry, the page you visited does not exist') },
			{
				errorCode: '401',
				errorImg: error401,
				errorDescription: L('Sorry, you dont have access to this page'),
			},
			{ errorCode: '500', errorImg: error500, errorDescription: L('Sorry, the server is reporting an error') },
		];
