...
export default class BaoCaoKiemKeSachTrong1KeHoach extends AppComponentBase {
				...
				<Row>
					<Col span={24} style={{ textAlign: "right" }}>
						<ActionExport
							...
							isExcel={true}
							idPrint={"1"}
							nameFileExport={"Báo cáo kiểm kê sách trong 1 kế hoạch"}
						/>
					</Col>
				</Row>
				<Row>
					...
					<Col span={12} style={{textAlign:'right'}}>
						...
						<h1 style={{fontSize: "25px",textAlign:'center'}}>Báo cáo kiểm kê sách trong 1 kế hoạch</h1>
