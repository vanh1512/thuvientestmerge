...
export default class BaoCaoMatSachTheoNgay extends AppComponentBase {
	render() {
		const data = [
			{
		...
		return (
			<Card>
				<Row>
					<Col span={24} style={{ textAlign: "right" }}>
						<ActionExport
							...
							isExcel={true}
							idPrint={"1"}
							nameFileExport={"Báo cáo mất sách theo Ngày"}
						/>
					</Col>
				</Row>
				...
				<h1 style={{textAlign:'center', fontSize:24}}>Báo cáo mất sách từ .../.../... đến ngày .../.../...</h1>
