...
import DetailInformationMember from '../UserInformation/components/DetailInfomationMember';
...
export default class NewHome extends AppComponentBase {
    ...
    render() {
        ...
        return (
            <>
                {(currentLogin.user && currentLogin.user.us_type == eUserType.Member.num) ?
                    <Card>
