...
export default class MostViewDocument extends AppComponentBase {
	...
	getAll = async () => {
		...
		await stores.gDocument.getByBorrow(undefined, this.state.skipCount, this.state.maxResultCount);
			...
			<>
				...
				<Card style={{ padding: '15px 5%', fontSize: 16, }}>
					<Row>
						<Col span={16} >
							<div>
								<h1 style={{ margin: 0 }}>Tài liệu có lượt mượn nhiều nhất</h1>
								<p> <CalendarOutlined style={{ color: 'red' }} />&nbsp;<i>11/7/2023 </i> &nbsp;&nbsp;<EyeOutlined style={{ color: 'red' }} /> &nbsp;<i>3035</i></p>
							</div>
							<h2 style={{ textAlign: 'center' }}>Danh sách tài liệu có lượt mượn nhiều nhất</h2>
